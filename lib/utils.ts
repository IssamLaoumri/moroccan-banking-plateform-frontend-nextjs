...
export const authFormSchema = (type: string) =>
	z.object({
		// sign up
		firstName: type === "sign-in" ? z.string().optional() : z.string().min(2).max(25),
		lastName: type === "sign-in" ? z.string().optional() : z.string().min(2).max(25),
		address1: type === "sign-in" ? z.string().optional() : z.string().min(3).max(75),
		city: type === "sign-in" ? z.string().optional() : z.string().min(3).max(75),
		state: type === "sign-in" ? z.string().optional() : z.string().min(3).max(50),
		postalCode: type === "sign-in" ? z.string().optional() : z.string().min(3).max(25),
